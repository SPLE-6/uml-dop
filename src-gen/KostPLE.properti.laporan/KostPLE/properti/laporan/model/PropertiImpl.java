...
public class PropertiImpl extends PropertiDecorator {
	...
	protected EFloat pemasukan;
	protected EFloat pengeluaran;
	public PropertiImpl(
        super();
	...
	public EFloat getPemasukan() {
		return this.pemasukan;
	}

	public void setPemasukan(EFloat pemasukan) {
		this.pemasukan = pemasukan;
	}
	public EFloat getPengeluaran() {
		return this.pengeluaran;
	}

	public void setPengeluaran(EFloat pengeluaran) {
		this.pengeluaran = pengeluaran;
	}
